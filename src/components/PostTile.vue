...
<template>
    ...
    <div class="bg-center rounded-t-2xl bg-cover pt-[40%] w-full" :style="`background-image: url(${post.previewPicture});`" />
    <div class="w-full py-4 px-6">
      ...
      <!-- User profile -->
      <RouterLink :to="`/profile/${post.user.id}`" class="w-full mt-4 flex items-center cursor-pointer hover:opacity-80">
